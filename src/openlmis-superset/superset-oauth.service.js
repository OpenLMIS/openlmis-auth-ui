...
(function() {
    ...
    /**
     * @ngdoc service
     * @name superset:supersetOAuthService
     * @description
    ...
    function supersetOAuthService(supersetUrlFactory, $q, $http, $httpParamSerializer, authUrl) {
        ...
        /**
         * @ngdoc method
         * @methodOf superset:supersetOAuthService
        ...
        function sendOAuthRequest(username, password, supersetOAuthState) {
            return $http({
                ...
                .catch(function() {
                    return $q.reject('superset.oAuthLogin.invalidCredentialsOrOAuthRequest');
                });
        }
        ...
        function approveSuperset(username, password) {
            return $http({
                ...
                .catch(function() {
                    return $q.reject('superset.oAuthLogin.unsuccessfulApprovingPermissions');
                });
        }
